...
public class Babaanne : BaseEnemy
{
    [Header("Babaanne Specific Stats")]
    public float BabaanneHealth = 100f;
    public float BabaanneMoveSpeed = 5f;

    protected override void Start()
    {
        // BaseEnemy'den alýnan özelliklerin güncellenmesi
        Health = BabaanneHealth;
        MoveSpeed = BabaanneMoveSpeed;
